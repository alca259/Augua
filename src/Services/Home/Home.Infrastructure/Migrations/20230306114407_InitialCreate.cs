    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthApplication", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthAuthorization", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuthAuthorization_AuthApplication_ApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    User_Id = table.Column<string>(type: "nvarchar(128)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuthToken_AuthApplication_ApplicationId",
                        column: x => x.ApplicationId,
                        principalSchema: "Identity",
                        principalTable: "AuthApplication",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthToken_AuthAuthorization_AuthorizationId",
                        column: x => x.AuthorizationId,
                        principalSchema: "Identity",
                        principalTable: "AuthAuthorization",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_AuthApplication_ClientId",
                schema: "Identity",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthAuthorization_ApplicationId_Status_Subject_Type",
                schema: "Identity",
                table: "AuthAuthorization",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthToken_ApplicationId_Status_Subject_Type",
                schema: "Identity",
                table: "AuthToken",
                columns: new[] { "ApplicationId", "Status", "Subject", "Type" });

            migrationBuilder.CreateIndex(
                name: "IX_AuthToken_AuthorizationId",
                schema: "Identity",
                table: "AuthToken",
                column: "AuthorizationId");

            migrationBuilder.CreateIndex(
                name: "IX_AuthToken_ReferenceId",
                schema: "Identity",
                table: "AuthToken",
                column: "ReferenceId",
                unique: true,
